...
<head>
    ...
    <title>Al-Rhombus Nuts & Bolts | Warsha Al-Haizum لسيلنة السيارات | Welcome to Admin Screen</title>
...
<body>
    ...
    <section id="inventory">
        ...
        <div class="item">   
            <div id="item1" class="box">
                <button class="in_ven"><a href="inventory1.php"><img src="./img/inventory1.jpg" alt=""></a></button>

                <?php 
                    $sql = "select * from inventories where name = 'Wrench Screw Tools'";
                    $result = mysqli_query($con, $sql);

                    $rows = mysqli_fetch_assoc($result);

                    $_SESSION['quantity1'] = $rows['quantity'];
                ?>

                <h3>Wrench Screw Tools</h3>
                <span><b>Available quantity: <?php echo $_SESSION['quantity1'] ?> pcs</b></span>
            </div>
    
            <div id="item2" class="box">
                <button class="in_ven"><a href="inventory2.php"><img src="./img/inventory2.jpg" alt=""></a></button>

                <?php 
                    $sql = "select * from inventories where name = 'Migatronic Welding'";
                    $result = mysqli_query($con, $sql);

                    $rows = mysqli_fetch_assoc($result);

                    $_SESSION['quantity2'] = $rows['quantity'];

                ?>

                <h3>Migatronic Welding</h3>
                <span><b>Available quantity: <?php echo $_SESSION['quantity2'] ?> pcs</b></span>
            </div>
    
            <div id="item3" class="box">
                <button class="in_ven"><a href="inventory3.php"><img src="./img/inventory3.jpg" alt=""></a></button>

                <?php 
                    $sql = "select * from inventories where name = 'Gas radiator'";
                    $result = mysqli_query($con, $sql);

                    $rows = mysqli_fetch_assoc($result);

                    $_SESSION['quantity3'] = $rows['quantity'];

                ?>

                <h3>Gas radiator</h3>
                <span><b>Available quantity: <?php echo $_SESSION['quantity3'] ?> pcs</b></span>
            </div>
    
            <div id="item4" class="box">
                <button class="in_ven"><a href="inventory4.php"><img src="./img/inventory4.jpg" alt=""></a></button>

                <?php 
                    $sql = "select * from inventories where name = 'Cutters Millings'";
                    $result = mysqli_query($con, $sql);

                    $rows = mysqli_fetch_assoc($result);

                    $_SESSION['quantity4'] = $rows['quantity'];

                ?>

                <h3>Cutters Millings</h3>
                <span><b>Available quantity: <?php echo $_SESSION['quantity4'] ?> pcs</b></span>
            </div>
    
            <div id="item5" class="box">
                <button class="in_ven"><a href="inventory5.php"><img src="./img/inventory5.jpg" alt=""></a></button>

                <?php 
                    $sql = "select * from inventories where name = 'Painting Stuffs'";
                    $result = mysqli_query($con, $sql);

                    $rows = mysqli_fetch_assoc($result);

                    $_SESSION['quantity5'] = $rows['quantity'];

                ?>

                <h3>Painting Stuffs</h3>
                <span><b>Available quantity: <?php echo $_SESSION['quantity5'] ?> pcs</b></span>
            </div>
    
            <div id="item6" class="box">
                <button class="in_ven"><a href="inventory6.php"><img src="./img/inventory6.jpg" alt=""></a></button>

                <?php 
                    $sql = "select * from inventories where name = 'Engine Compartment'";
                    $result = mysqli_query($con, $sql);

                    $rows = mysqli_fetch_assoc($result);

                    $_SESSION['quantity6'] = $rows['quantity'];

                ?>

                <h3>Engine Compartment</h3>
                <span><b>Available quantity: <?php echo $_SESSION['quantity6'] ?> pcs</b></span>
            </div>
    
            <div id="item7" class="box">
                <button class="in_ven"><a href="inventory7.php"><img src="./img/inventory7.jpg" alt=""></a></button>

                <?php 
                    $sql = "select * from inventories where name = 'Motor Engage'";
                    $result = mysqli_query($con, $sql);

                    $rows = mysqli_fetch_assoc($result);

                    $_SESSION['quantity7'] = $rows['quantity'];

                ?>

                <h3>Motor Engage</h3>
                <span><b>Available quantity: <?php echo $_SESSION['quantity7'] ?> pcs</b></span>
            </div>
    
            <div id="item8" class="box">
                <button class="in_ven"><a href="inventory8.php"><img src="./img/inventory8.jpg" alt=""></a></button>

                <?php 
                    $sql = "select * from inventories where name = 'Drills Equipments'";
                    $result = mysqli_query($con, $sql);

                    $rows = mysqli_fetch_assoc($result);

                    $_SESSION['quantity8'] = $rows['quantity'];
                ?>

                <h3>Drills Equipments</h3>
                <span><b>Available quantity: <?php echo $_SESSION['quantity8'] ?> pcs</b></span>
            </div>
        </div>
    ...
    <section id="information">
        <div>
            <h1 class="h1-primary">Services Information and Details</h1>
            <button class="btn"><a href="services_information.php">Show All Services Information</a></button>
        </div>
        <hr>
    </section>
    ...
    <section id="information">
        <div>
            <h1 class="h1-primary">Cars Information and Details</h1>
            <button class="btn"><a href="cars_information.php">Show All Cars Information</a></button>
        </div>
    </section>
    ...
    <section id="admin-form">
        ...
        <div>
            <form action="admin_b.php" method="post">
                ...
                Qualification: <label for="qualification"></label>
                <input type="text" name="qualification" id="contact" placeholder="Qualification">

                Experience: <label for="experience"></label>
                <input type="text" name="experience" id="contact" placeholder="Experience" required>
