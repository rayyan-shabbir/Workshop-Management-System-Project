...
<head>
    ...
    <title> Al-Rhombus Nuts and Bolts | Customer's Services Information</title>
    ...
    <link rel="stylesheet" href="style_contacttt1.css">
</head>
<body>
    <section id="info">

    <h1 style="font-size: 4.6rem;">Customer's Services Details</h1>
    ...
    <table align="center" border="1px" style="width: 1300px; line-height: 40px;">
        ...
        <tr>
            ...
            <th style="font-size: 1.5rem;">PHONE</th>
            <th style="font-size: 1.5rem;">ADDRESS</th>
            <th style="font-size: 1.5rem;">SERVICES</th>
            <th style="font-size: 1.5rem;">APPOINTMENT DATE</th>
        </tr>
